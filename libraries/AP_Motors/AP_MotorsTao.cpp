...
// Battery: 191.7g.
// Payload: 1098.3g.
// Total weight: 3455.3g.
// Q = [5 5 5 10 10 10 10 10 10 10 10 10]. R = [1 1 1 1 1].
const float K[MAX_ROTOR_IN_COPTER][NUM_COL] = {
    {-1.1059f,  1.1876f,    -0.9098f,   9.0134f,    8.3663f,    0.8667f,    -2.0831f,   2.2362f,    -1.6720f,   1.8364f,    1.6628f,    1.2722f},
    {1.2057f,   1.1546f,    -1.0497f,   8.9594f,    -9.2392f,   0.2776f,    2.2764f,    2.1852f,    -1.9336f,   1.8454f,    -1.8800f,   0.3809f},
    {-0.9722f,  -1.0304f,   -0.9426f,   -8.3438f,   7.8340f,    1.2372f,    -1.8559f,   -1.9707f,   -1.7312f,   -1.7364f,   1.6389f,    1.8851f},
    {1.0650f,   -1.0830f,   -1.0828f,   -8.5536f,   -8.5866f,   0.4560f,    2.0323f,    -2.0586f,   -1.9944f,   -1.7660f,   -1.8211f,   0.7052f},
    {-0.4939f,  -0.1479f,   -1.0048f,   -0.5015f,   3.9370f,    -2.7268f,   -0.9398f,   -0.2424f,   -1.8661f,   -0.0694f,   0.8588f,    -4.1292f},
};
